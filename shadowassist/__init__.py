...
if not os.path.isfile(dbPath):
    data = [
        ...
        Skill(name="Alchemie",          level=8,    attribute="magic"),
        Specialization(skill_id=1,  name="Berührung"),
        Skill(name="Herbeirufen",       level=6,    attribute="magic"),
        Skill(name="Spruchzauberei",    level=6,    attribute="magic"),
        Skill(name="Arkana",            level=5,    attribute="logic"),
        Skill(name="Chemie",            level=4,    attribute="logic"),
        Skill(name="Wahrnehmung",       level=4,    attribute="intuition"),
        Specialization(skill_id=6, name="Sehen"),
        Specialization(skill_id=6, name="Hören"),
        Skill(name="Überreden",         level=2,    attribute="charisma"),
        Skill(name="Askennen",          level=1,    attribute="intuition"),
        Skill(name="Bodenfahrzeuge",    level=1,    attribute="reaction"),
        Skill(name="Erste Hilfe",       level=1,    attribute="logic"),
        Skill(name="Klingenwaffen",     level=1,    attribute="agility"),
        Skill(name="Pistolen",          level=1,    attribute="agility"),
        Skill(name="Ritualzauberei",    level=1,    attribute="Magic"),
        Skill(name="Verkleiden",        level=1,    attribute="intuition"),
